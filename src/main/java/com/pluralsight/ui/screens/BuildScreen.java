...
// -------------------------------------- [ Step 3: Button Set ] ------------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            ...
            case "N": IO.println("No custom button set added.");            break;
            default:  IO.println("Input not valid. Please enter Y or N.");  break;
        }
// -------------------------------------- [ Step 4: Joystick Color ] --------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            ...
            case "N": IO.println("No custom joystick color added.");                          break;
            default:  IO.println("Input not valid. Please enter Y or N.");                    break;
        }
// -------------------------------------- [ Step 5: C-Stick Color ] --------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            ...
            case "N":  IO.println("No custom C-stick color added.");                         break;
            default:  IO.println("Input not valid. Please enter Y or N.");                   break;
        }
// -------------------------------------- [ Step 6: Snapback Mod ] ----------------------------------------------------
...
// -------------------------------------- [ Step 7: TactileZ Mod ] ----------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            case "Y":
                ...
                IO.println("Tactile Z mod added!");                        break;

            case "N":  IO.println("No tactile Z mod added.");              break;
            default:  IO.println("Input not valid. Please enter Y or N."); break;
        }
...
// -------------------------------------- [ Step 8: Notch Mod ] -------------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            case "Y":
                ...
                break;
            case "N": IO.println("No notch mod added.");         break;
            default:  IO.println("\nInvalid input. Try again."); break;
        }
// -------------------------------------- [ Step 9: Trigger Mod ] -----------------------------------------------------
        ...
        switch (scanner.nextLine().toUpperCase())
        {
            case "Y":
               ...
               break;
            case "N": IO.println("No trigger mod added.");        break;
            default:  IO.println("\n Invalid input. Try again."); break;
